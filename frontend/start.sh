...
for file in assets/*.js;
 do
  ...
  sed -i -e "s|AUTH_URL_PLACEHOLDER|${AUTH_URL:-default_auth_url}|g" \
         ...
         -e "s|FEATURE_FLAG_ORG_RESOURCE_STATE_OVERRIDE_PLACEHOLDER|${FEATURE_FLAG_ORG_RESOURCE_STATE_OVERRIDE:-true}|g" \
         -e "s|FEATURE_FLAG_COLLABORATORS_PLACEHOLDER|${FEATURE_FLAG_COLLABORATORS:-false}|g" \
